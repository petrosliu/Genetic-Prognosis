function [index,erre,e,t]=diaLDA(trainingData,testingData,...
    ...
    switch estimate
    	case 'resubstitution'
            parfor i=1:num
                ...
                mdlhat=fitcdiscr(X,y,'DiscrimType','diagLinear',...
                                    'Prior','uniform');
    ...
    y=trainingData.label;
    mdl=fitcdiscr(X,y,'DiscrimType','diagLinear','Prior','uniform');
